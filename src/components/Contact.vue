  ...
  <form @submit.prevent="sendEmail()">
    <div class="name">
      <div class="form_items name">
        ...
        <input type="text" v-model.capitalize.trim="last_name" name="last_name" id="last_name" required>
      </div>
      <div class="form_items name">
        <label for="first_name">Prénom : </label>
        <input type="text" vmodel.trim="first_name" name="first_name" id="first_name" required>
      </div>
    </div>
    <div class="form_items">
      <label for="object">Objet : </label>
      <input type="text" v-model.trim="object" name="object" id="object" required>
    </div>
    <div class="form_items">
